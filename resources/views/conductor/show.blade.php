                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col s8 offset-s2 m7">
                                <p class="secondary-text-color">{{$conductor->ci}}</p>
                            </div>
                            ...
                            <div class="col s8 offset-s2 m7">
                                <p class="secondary-text-color">{{$conductor->nombre}}</p>
                            </div>
                            ...
                            <div class="col s8 offset-s2 m7">
                                <p class="secondary-text-color">{{$conductor->apellido}}</p>
                            </div>
                            ...
                            <div class="col s8 offset-s2 m7">
                                <p class="secondary-text-color">{{$conductor->direccion}}</p>
                            </div>
                            ...
                            <div class="col s8 offset-s2 m7">
                                <p class="secondary-text-color">{{$conductor->edad}}</p>
                            </div>
