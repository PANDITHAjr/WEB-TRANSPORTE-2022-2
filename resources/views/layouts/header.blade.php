    ...
    <div class="nav-wrapper">
        @auth
            ...
            <ul id="nav-mobile" class="right">
                @if (auth()->user()->personal->tipo_personal->descripcion == 'Cliente')
                    <li><a style="color: red;" href="{{ route('home2') }}" class="waves-effect dark-primary-color-text"
                            type="submit"><i class="material-icons">home</i></a></li>
                @else
                    <li><a style="color: red;" href="{{ route('home') }}" class="waves-effect dark-primary-color-text"
                            type="submit"><i class="material-icons">home</i></a></li>
                @endif
