...
@section('content')
    <div class="row" style="margin-top: 5%">
        <div class="col s4">
            <a href="{{ route('usuario.create') }}" class="waves-effect light-blue accent-4 btn"><i
                        ...
                        <tbody>
                            @foreach ($usuarios as $usuario)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('usuario.show', [$usuario->id]) }}"><span
                                        ...
                                        <a href="{{ route('usuario.destroy', [$usuario->id]) }}"><span
                        ...
                        <ul class="pagination" style="margin: 0;">
                            ...
                            @else
                                <li class="waves-effect"><a style="color: blue; font-weight: bold;"
                                        href="{{ $usuarios->previousPageUrl() }}">ANTERIOR</a></li>
                            @endif

                            {{-- Next Page Link --}}
                            @if ($usuarios->hasMorePages())
                                <li class="waves-effect"><a style="color: blue; font-weight: bold;"
                                        href="{{ $usuarios->nextPageUrl() }}">SIGUIENTE</a></li>
                            @else
