                    ...
                    <div class="card-content">
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s12 m6">
                                <input id="ci_cliente" type="number" class="validate" name="ci_cliente" value="{{ $cliente->ci_cliente }}">
                            ...
                            <div class="input-field col s12 m6">
                                <input id="phone" type="number" class="validate" name="telefono" value="{{ $cliente->telefono }}">
